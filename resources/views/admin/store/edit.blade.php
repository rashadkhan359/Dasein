        ...
        <form autocomplete="off" class="needs-validation createCategory-form" id="createCategory-form"
            ...
            <div class="row">
                <div class="col-xxl-12 col-lg-6">
                    <div class="mb-3">
                        <label for="storeTitle" class="form-label">Store Title<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="storeTitle" placeholder="Enter title" value="{{ old('name') ?? $store->name }}"
                            name="name" required>
                ...
                <div class="col-xxl-12 col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="position-relative d-inline-block">
                            <input type="hidden" name="image" id="image" value="{{ old('image') ?? $store->image }}">
                            @if ($store->image)
                ...
                <div class="col-xxl-12 col-lg-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descriptionInput" rows="3" placeholder="Description" required name="description">{{ old('description') ?? $store->description }}</textarea>
