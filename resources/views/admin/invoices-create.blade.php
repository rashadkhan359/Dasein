...
@endsection
@section('content')
    <x-breadcrumb title="Create Invoice" pagetitle="Invoices" />
                    ...
                    <div class="card-body border-bottom border-bottom-dashed p-4">
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div>
                                    ...
                                    <div class="mb-2 mb-lg-0">
                                        <input type="text" class="form-control" id="companyaddpostalcode" minlength="5"
                            ...
                            <div class="col-lg-4 ms-auto">
                                ...
                                <div class="mb-2">
                                    <input type="email" class="form-control" id="companyEmail" placeholder="Email Address"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-2">
                                    <input type="text" class="form-control" id="companyWebsite" placeholder="Website"
                                        required>
                                    <div class="invalid-feedback">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-3 col-sm-6">
                                <label for="invoicenoInput" class="form-label">Invoice No</label>
                                <input type="text" class="form-control" id="invoicenoInput" placeholder="Invoice No"
                                    value="#VL25000355" readonly="readonly">
                            </div>
                            <!--end col-->
                            <div class="col-lg-3 col-sm-6">
                                <div>
                                    <label for="date-field" class="form-label">Date</label>
                                    <input type="text" class="form-control" id="date-field" data-provider="flatpickr"
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="totalamountInput" placeholder="$0.00"
                                        readonly>
                                </div>
                            </div>
                            <!--end col-->
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div>
                                    <label for="billingName"
                                        class="text-muted text-uppercase fw-semibold form-label">Billing Address</label>
                                </div>
                                <div class="mb-2">
                                    <input type="text" class="form-control" id="billingName" placeholder="Full Name"
                                        required>
                                    <div class="invalid-feedback">
                    ...
                    <div class="card-body p-4">
                            ...
                            <table class="invoice-table table table-borderless table-nowrap mb-0">
                                ...
                                <tbody id="newlink">
                                    <tr id="1" class="product">
                                        ...
                                        <td>
                                            <input type="number" class="form-control product-price" id="productRate-1"
                                        ...
                                        <td class="text-end">
                                            <div>
                                                <input type="text" class="form-control product-line-price"
                                            ...
                                            <table class="table table-borderless table-sm table-nowrap align-middle mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" id="cart-discount"
                                                                placeholder="$0.00" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" id="cart-shipping"
                                                                placeholder="$0.00" readonly>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="form-control alert alert-warning" id="exampleFormControlTextarea1" placeholder="Notes"
                                rows="2" required>All accounts are to be paid within 7 days from receipt of invoice. To be paid by cheque or credit card or direct payment online. If account is not paid within 7 days the credits details supplied as confirmation of work undertaken will be charged the agreed quoted fee noted above.</textarea>
                        </div>
