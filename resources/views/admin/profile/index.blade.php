                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <div class="profile-user-img position-relative">
                            ...
                            @else
                            src="{{ URL::asset('backend/build/images/users/avatar-1.jpg') }}" @endif
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control @error('designation') is-invalid @enderror"
                                        id="designationInput" name="designation" placeholder="Designation"
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control @error('website') is-invalid @enderror"
                                        id="websiteInput1" name="website" placeholder="www.example.com"
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <input type="password" class="form-control pe-5 password-input"
                                            onpaste="return false" placeholder="Confirm password" name="current_password"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="news&Upates" checked>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="commentsList" id="donotNotifyme">
                        ...
                        <div class="col-lg-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="commentsList" id="mentionsOnly">
