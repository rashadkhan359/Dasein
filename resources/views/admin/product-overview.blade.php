                        ...
                        <div class="swiper-wrapper product-wrapper">
                            <div class="swiper-slide">
                                <div class="product-thumb rounded cursor-pointer">
                                    <img src="{{ URL::asset('build/images/products/img-31.png') }}" alt="" class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product-thumb rounded cursor-pointer">
                                    <img src="{{ URL::asset('build/images/products/img-32.png') }}" alt="" class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product-thumb rounded cursor-pointer">
                                    <img src="{{ URL::asset('build/images/products/img-33.png') }}" alt="" class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product-thumb rounded cursor-pointer">
                                    <img src="{{ URL::asset('build/images/products/img-34.png') }}" alt="" class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product-thumb rounded cursor-pointer">
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/backend/product-details.init.js') }}"></script>
