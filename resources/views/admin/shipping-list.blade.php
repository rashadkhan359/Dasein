                ...
                <div data-simplebar style="max-height: calc(100vh - 150px);">
                    <div class="row gy-4">
                        <div class="col-lg-12">
                            <div class="card mb-0">
                                <div class="card-body">
                                    <span class="badge bg-danger-subtle text-danger float-end clearfix">Out Of Delivery</span>
                        ...
                        <div class="col-lg-12">
                            <div class="card border-primary border-opacity-50 mb-0">
                                <div class="card-body">
                                    <span class="badge bg-info-subtle text-info float-end clearfix">Shipping</span>
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-0">
                                <div class="card-body">
                                    <span class="badge bg-success-subtle text-success float-end clearfix">Delivered</span>
                                    <h5 class="fs-18 mb-3">Themesbrand Logistics</h5>
                                    <div class="d-flex align-items-end">
                                        <div class="flex-grow-1">
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-0">
                                <div class="card-body">
                                    <span class="badge bg-secondary-subtle text-secondary float-end clearfix">Pickup</span>
                                    <h5 class="fs-18 mb-3">Toner Logistics</h5>
                                    <div class="d-flex align-items-end">
                                        <div class="flex-grow-1">
...
@section('scripts')
    ...
    <!--shipping list init-->
    <script src="{{ URL::asset('build/js/backend/shipping-list.init.js') }}"></script>​
