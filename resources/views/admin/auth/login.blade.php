                            ...
                            <div class="card-header bg-primary border-0">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-9">
                                        <h1 class="text-white lh-base fw-lighter">Admin Login</h1>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="email" type="email"
                                                ...
                                                value="rashadkhan359@gmail.com" required autocomplete="email" autofocus
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input id="password" type="password"
                                                    ...
                                                    name="password" required autocomplete="current-password" placeholder="Enter your password" value="password123">
                                                <button
