...
@section('content')
                                            ...
                                            <ul class="hstack gap-2 list-unstyled mb-0">
                                                <li>
                                                    <a href="#couponDetails" data-bs-toggle="offcanvas"
                                                        class="badge bg-dark-subtle text-body view-item-btn">View</a>
                                                </li>
                                                <li>
                                                    <a class="badge bg-primary-subtle text-primary edit-item-btn" href="#showModal"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="couponDetails" aria-labelledby="couponDetailsLabel">
        ...
        <div class="offcanvas-body">
            <div>
                <img src="{{ URL::asset('build/images/ecommerce/offer-banner.jpg') }}" alt="" class="img-thumbnail">
            </div>
            <div class="mt-3">
...
@section('scripts')
    ...
    <!-- App js -->
    <script src="{{ URL::asset('build/js/backend/coupons.init.js') }}"></script>
