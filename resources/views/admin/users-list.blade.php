                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="status"><span class="badge bg-danger-subtle text-danger">Inactive</span></td>
                                    <td>
                            ...
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="avatar-lg p-1">
                                    <div class="avatar-title bg-light rounded-circle">
                                        <img src="{{ URL::asset('build/images/users/user-dummy-img.jpg') }}" id="users-img-field"
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/backend/users-list.init.js') }}"></script>
