...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Buttons" pagetitle="Base UI" />
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <button type="button" class="btn btn-primary btn-animation"
                            data-text="Primary"><span>Primary</span></button>
                        <button type="button" class="btn btn-secondary btn-animation"
                        ...
                        <button type="button" class="btn btn-info btn-animation"
                        ...
                        <button type="button" class="btn btn-danger btn-animation"
                            data-text="Danger"><span>Danger</span></button>
                        <button type="button" class="btn btn-dark btn-animation"
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-wrap gap-2">
                                <button type="button" class="btn btn-primary btn-label right"><i
                                        class="ri-user-smile-line label-icon align-middle fs-16 ms-2"></i> Primary</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="hstack gap-2 mt-4 mt-sm-0">
                                ...
                                <button type="button" class="btn btn-outline-danger btn-icon"><i
                                        class="ri-customer-service-2-line"></i></button>
                                <button type="button" class="btn btn-outline-success btn-icon"><i
                                        class="ri-mail-send-line"></i></button>
                                <button type="button" class="btn btn-outline-warning btn-icon"><i
