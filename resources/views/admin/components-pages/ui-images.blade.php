...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Images" pagetitle="Base UI" />
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use <code>img-thumbnail</code> class to give an image rounded 1px border
                        appearance.</p>
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-lg-0 mt-3">
                                <p class="text-muted">Use <code>avatar-group</code> class to show avatar images with the
                                    group.</p>
