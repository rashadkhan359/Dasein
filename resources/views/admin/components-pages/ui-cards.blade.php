...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Cards" pagetitle="Base UI" />
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt="Card image">
                        <div class="card-img-overlay p-0 d-flex flex-column">
                            ...
                            <div class="card-footer bg-transparent text-center">
                                <a href="javascript:void(0);" class="link-light text-white">Read More <i
                                        class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt="Card image cap">
                        <div class="card-header">
                            <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="Card image cap">
                    </div>
                </div><!-- end col -->
            </div>
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover"
                                    src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('build/images/small/img-4.jpg') }}"
                                    alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('build/images/small/img-2.jpg') }}"
                                    alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-footer">
                            <div class="text-center">
                                <a href="javascript:void(0);" class="link-light text-white">Connect Now <i
            ...
            <div class="card border card-border-dark">
                ...
                <div class="card-body">
                    <p class="card-text">They all have something to say beyond the words on the page. They can come across
                        ...
                        squid.</p>
                    <div class="text-end">
                        <a href="javascript:void(0);" class="link-dark text-body fw-medium">Read More <i
                                class="ri-arrow-right-line align-middle"></i></a>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-md-4">
            <div class="card h-100">
                ...
                <img class="img-fluid" src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="Card image cap" />
                <div class="card-body">
