...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Utilities" pagetitle="Base UI" />
                    ...
                    <div class="live-preview">
                        <div>
                            <div>
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded"
                                            alt="rounded">
                                        <p><code>.rounded</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-top"
                                            alt="rounded-top">
                                        <p><code>.rounded-top</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-end"
                                            alt="rounded-end">
                                        <p><code>.rounded-end</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-bottom"
                                            alt="rounded-bottom">
                                        <p><code>.rounded-bottom</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-start"
                                            alt="rounded-start">
                                        <p><code>.rounded-start</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-circle"
                                            alt="rounded-circle">
                                    ...
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" class="avatar-md w-auto rounded-pill"
                                            alt="rounded-pill">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-0"
                                            alt="rounded-0">
                                        <p><code>.rounded-0</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-1"
                                            alt="rounded-1">
                                        <p><code>.rounded-1</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-2"
                                            alt="rounded-2">
                                        <p><code>.rounded-2</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-3"
                                            alt="rounded-3">
                                        <p><code>.rounded-3</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-4"
                                            alt="rounded-4">
                                        <p><code>.rounded-4</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-5"
                                            alt="rounded-5">
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <p class="pe-none mb-0"><a href="#" class="text-success" tabindex="-1">This link</a> can
                            not be clicked because the <code>pointer-events</code> property is inherited from its parent.
                                ...
                                <div class="mt-4 mt-xl-0">
                                    ...
                                    <div class="d-md-flex bg-light">
                                        <div class="overflow-hidden p-3 mb-0 bg-light" style="height: 100px;">
                                            ...
                                            width and height dimensions. Lorem ipsum dolor sit amet, consectetur adipiscing
                                ...
                                <div class="mt-4 mt-xl-0">
                                    ...
                                    <div class="d-md-flex bg-light">
                                        <div class="overflow-visible p-3 mb-0 bg-light" style="height: 100px;">
                                            This is an example of using <code>.overflow-visible</code> on an element with
