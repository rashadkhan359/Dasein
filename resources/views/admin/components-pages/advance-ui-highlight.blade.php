...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Highlight" pagetitle="Advanced UI" />
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">HTML highlight is used to mark or highlight text that is of property,
...
&lt;html&gt;
    &lt;head&gt;
        &lt;title&gt;Toner - Responsive Admin Dashboard Template&lt;/title&gt;
    &lt;/head&gt;
    &lt;body&gt;
        &lt;div&gt;
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">CSS highlight is used to mark or highlight text that is of property,
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">Javascript highlight is used to mark or highlight text that is of property,
