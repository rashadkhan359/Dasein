...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="ScrollSpy" pagetitle="Advance UI" />
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute to update links in a navigation list
                        based on the current scroll position. Scroll the area below the navbar and watch the active class
                        change.</p>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute. Scrollspy also works with nested
                        nav. If a nested nav is active, its parents will also be active. Scroll the area next to the navbar
                        and watch the active class change.</p>
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-3">
                        ...
                        <div class="row gy-4">
                            <div class="col-xxl-3">
                                <div id="list-example" class="list-group">
                                    ...
                                    <a class="list-group-item list-group-item-action active" href="#list-item-2">Item
                                        2</a>
