...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Lists" pagetitle="Base UI" />
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item list-group-fill-light text-body">A simple light list group item</li>
                ...
                <div class="card-body">
                    ...
                    <div class="list-group">
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action active">
                            ...
                            <p class="list-text mb-0">They all have something to say beyond the words on the page. They can
                                come across as casual or neutral, exotic or graphic. That's why it's important to think
                                about your message, then choose a font that fits. Cosby sweater eu banh mi, qui irure terry
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action">
                            ...
                            <p class="list-text mb-0">Big July earthquakes confound zany experimental vow. My girl wove six
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action">
                            ...
                            <p class="list-text mb-0">Just like in the image where we talked about using multiple fonts,
                                ...
                                top of an image, it’s important that your viewers can understand the text, and sometimes
                                that means applying a gaussian readable.</p>
                        </a>
                    </div>
                </div><!-- end card-body -->
                <div class="card-body bg-light border-bottom border-top bg-opacity-25">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><i class="mdi mdi-check-bold align-middle lh-1 me-2"></i> Send over
                            all the documentation.</li>
                        <li class="list-group-item"><i class="mdi mdi-check-bold align-middle lh-1 me-2"></i> Meeting with
                            daron to review the intake form</li>
                        <li class="list-group-item"><i class="mdi mdi-check-bold align-middle lh-1 me-2"></i> Check
                            uikings theme and give customer support</li>
                        <li class="list-group-item"><i class="mdi mdi-check-bold align-middle lh-1 me-2"></i> Start making
                            a presentation</li>
                    </ul>
                </div><!-- end card-body -->
                <div class="card-body bg-light border-bottom border-top bg-opacity-25">
