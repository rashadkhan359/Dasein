...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Profile" pagetitle="Base UI" />
                ...
                <div class="card-body">
                    <div class="card border-0 shadow-none mb-0">
                        <div class="card-body rounded profile-basic"
                            style="background-image: url('build/images/small/img-4.jpg');background-size: cover;"></div>
                        <div class="card-body">
                            <div class="mt-n5">
                                <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt=""
                                    class="avatar-lg rounded-circle p-1 bg-body mt-n3">
                            </div>
                        </div>
                            ...
                            <div class="row justify-content-between gy-4">
                                <div class="col-xl-5 col-md-7">
                                    ...
                                    <div class="hstack gap-2">
                                        ...
                                        <div class="dropdown">
                                            <button class="btn btn-soft-danger btn-icon" type="button"
                                ...
                                <div class="col-xl-3 col-md-5">
                                    ...
                                    <div>
                                        ...
                                        <ul class="d-flex gap-2 flex-wrap list-unstyled mb-0">
                                            <li>
                                                <span class="badge bg-dark-subtle text-body">Business Marketing</span>
                                            </li>
                                            <li>
                                                <span class="badge bg-dark-subtle text-body">Google Ads Management</span>
                                            </li>
                                            <li>
                                                <span class="badge bg-dark-subtle text-body">Social Ads Management</span>
                                            </li>
                                            <li>
                                                <span class="badge bg-dark-subtle text-body">Content SEO</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="card border-0 shadow-none mb-0">
                        ...
                        <div class="card-body">
                            <div class="mt-n5 text-center">
                                <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt=""
                                    class="avatar-lg rounded-circle p-1 bg-body mt-n3 mx-auto">
                            </div>
                        </div>
                        <div class="card-body pt-0">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card border-0 shadow-none mb-0">
                        <div class="card-body rounded profile-basic"
                            style="background-image: url('build/images/small/img-4.jpg');background-size: cover;">
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row justify-content-between gy-4">
                                <div class="col-xl-3 col-md-5 order-last order-lg-first">
                                    ...
                                    <div class="text-end text-lg-start">
                                        <p class="text-muted fw-medium mb-2">Featured Skills</p>
                                        <ul
                                            class="d-flex gap-2 flex-wrap list-unstyled mb-0 justify-content-end justify-content-lg-start">
                                            <li>
                                                <span class="badge bg-dark-subtle text-body">Business Marketing</span>
                                            </li>
                                            <li>
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="" class="w-100 rounded object-fit-cover"
                        height="120">

                    <div class="text-center">
                        <div class="mt-n4">
                            <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt=""
                                class="avatar-md rounded-circle p-1  mt-n2">
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <div class="mt-n4">
                            <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt=""
                                class="avatar-md rounded-circle p-1 bg-body mt-n2">
                        </div>
                        <div class="mt-4 border-bottom border-bottom-dashed">
                            <h5 class="fs-17">Edward Diana</h5>
                            <p class="mb-3 text-muted">Marketing Expert</p>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="w-100 rounded object-fit-cover bg-success-subtle" style="height: 120px;"></div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card border-danger border-opacity-25">
                <div class="card-body">
                    <div class="w-100 rounded object-fit-cover bg-danger-subtle" style="height: 120px;"></div>
...
@section('scripts')
    <script src="{{ URL::asset('build/libs/tom-select/tom-select.base.min.js') }}"></script>
