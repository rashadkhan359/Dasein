...
@section('css')
    ...
    <!-- autocomplete css -->
    <link rel="stylesheet" href="{{ URL::asset('build/libs/@tarekraafat/autocomplete.js/autoComplete.css') }}">
@endsection
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Form Advanced" pagetitle="Forms" />
                            ...
                            <div>
                                ...
                                <div class="input-group" data-input-flag>
                                    <button class="btn btn-light border" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false"><img src="{{ URL::asset('build/images/flags/us.svg') }}" alt="flag img"
