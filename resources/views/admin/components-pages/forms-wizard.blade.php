...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Wizard" pagetitle="Forms" />
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body form-steps">
                    <form action="#">
                        <div class="text-center pt-3 pb-4 mb-1">
                            <img src="{{ URL::asset('build/images/logo-dark.png') }}" class="card-logo-dark" alt=""
                                height="26">
                            <img src="{{ URL::asset('build/images/logo-light.png') }}" class="card-logo-light" alt=""
                                height="26">
                        </div>
