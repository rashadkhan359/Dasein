...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Ribbons" pagetitle="Base UI" />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="ribbon-content mt-4 text-muted">
                                        <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis
                                            ...
                                            mattis dui. Aliquam  dictum aliquet. Nulla sapien mauris, eleifend et sem
                            ...
                            <div class="card ribbon-box border shadow-none mb-lg-0">
                                <div class="card-body">
                                    ...
                                    <div class="ribbon-content mt-4 text-muted">
                                        <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis
                                            dignissim eros at volutpat. In egestas
                                            mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem
                                            ac, commodo dapibus odio.</p>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <p class="text-muted">Use <code>trending-ribbon</code> class to show ribbon with hovering effect.
                        </p>
                        <div class="col-xxl-4">
                            <div class="card ribbon-box border shadow-none overflow-hidden mb-lg-0">
                                <div class="card-body text-muted">
                                    ...
                                    <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis
                                        ...
                                        Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio. Vivamus pretium nec
                                        odio cursus.</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body text-muted">
                                    <div class="ribbon ribbon-info ribbon-shape trending-ribbon">
                                        <i class="ri-flashlight-fill text-white align-bottom float-start me-1"></i> <span
                                            class="trending-ribbon-text">Trending</span>
                                    </div>
