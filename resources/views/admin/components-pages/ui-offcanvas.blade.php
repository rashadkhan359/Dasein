...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Offcanvas" pagetitle="Base UI" />
                                ...
                                <div class="acitivity-timeline p-4">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted mb-2">added a new member to Toner dashboard</p>
                                        ...
                                        <div class="gallery-box card light mb-0">
                                            ...
                                            <div class="box-content px-3 py-2">
                                                <div class="gallery-overlay">
                                                    <h5 class="overlay-caption">A mix of friends and strangers adventure.
                                                    </h5>
                                                </div>
