...
@section('css')
    <!-- add extra css -->
    <!-- shepherd.js css -->
    <link rel="stylesheet" href="{{ URL::asset('build/libs/shepherd.js/shepherd.css') }}">
@endsection
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Tour" pagetitle="Advance UI" />
                            ...
                            <div class="col-lg-5">
                                <div class="text-center mt-4 mb-5">
                                    ...
                                    <p class="text-muted">Vestibulum auctor tincidunt semper. Phasellus ut vulputate lacus.
                                        Suspendisse ultricies mi eros, sit amet tempor nulla varius sed dapibus in tellus.
                                    </p>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card border shadow-none">
                                            <div class="card-body text-center">
                                                ...
                                                <h5>Free register</h5>
                                                <p class="text-muted mb-0">Get your Free Toner account now.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
                                    <div class="col-lg-4">
                                        <div class="card border shadow-none">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted mb-0">Sign in to continue to Toner.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
