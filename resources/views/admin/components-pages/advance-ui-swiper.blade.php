...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Swiper Slider" pagetitle="Advance UI" />
                                ...
                                <div class="gallery-box card">
                                    <div class="gallery-container">
                                        <a class="image-popup" href="{{ URL::asset('build/images/small/img-1.jpg') }}" title="">
                                            <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-1.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                ...
                                <div class="gallery-box card">
                                    <div class="gallery-container">
                                        <a class="image-popup" href="{{ URL::asset('build/images/small/img-2.jpg') }}" title="">
                                            <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="box-content px-3 py-2">
                                ...
                                <div class="gallery-box card">
                                    <div class="gallery-container">
                                        <a class="image-popup" href="{{ URL::asset('build/images/small/img-4.jpg') }}" title="">
                                            <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-4.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="box-content px-3 py-2">
                                ...
                                <div class="gallery-box card">
                                    <div class="gallery-container">
                                        <a class="image-popup" href="{{ URL::asset('build/images/small/img-6.jpg') }}" title="">
                                            <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-6.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="box-content px-3 py-2">
