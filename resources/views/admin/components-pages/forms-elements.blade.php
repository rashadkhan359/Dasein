...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Basic Elements" pagetitle="Forms" />
                    ...
                    <div class="row align-items-center g-3">
                        <div class="col-lg-4">
                            <div>
                                ...
                                <p class="text-muted">Use <code>input</code> attribute with <code>type="file"</code>
                                    tag for default file input</p>
                        ...
                        <div class="col-lg-4">
                            <div>
                                ...
                                <p class="text-muted">Use <code>multiple</code> attribute within the input attribute to
                        ...
                        <div class="col-lg-4">
                            <div>
                                ...
                                <p class="text-muted">Use <code>disabled</code> attribute within the input attribute to
                                    disable the file input.</p>
                    ...
                    <div class="row mt-4 align-items-center g-3">
                        ...
                        <div class="col-lg-4">
                            <div>
                                ...
                                <p class="text-muted">Use <code>form-control-sm</code> class within the form-control class
                                    to set a small size file input.</p>
                        ...
                        <div class="col-lg-4">
                            <div>
                                ...
                                <p class="text-muted">Use <code>form-control </code>class and <code>type="file"</code>
                                    attribute within the input attribute to set a default size file input.</p>
                        ...
                        <div class="col-lg-4">
                            <div>
                                ...
                                <p class="text-muted">Use <code>form-control-lg</code> class within the form-control class
                                    to set a large size file input.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted">Use <code>input-group</code> class to div element which contains input
                            attribute to wrap a default input in the group.</p>
                        <div class="row g-3">
                            <div class="col-lg-6">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div>
                        <p class="text-muted">You can use a button with the dropdown toggle to set the file input group.
                        </p>
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="input-group">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Input groups include support for custom selects and custom file inputs. Browser
