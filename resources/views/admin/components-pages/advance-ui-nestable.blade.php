...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Nestable List" pagetitle="Advance UI" />
                    ...
                    <div class="list-group col nested-list nested-sortable">
                        <div class="list-group-item nested-1"> <i
                            ...
                            <div class="list-group nested-list nested-sortable">
                                ...
                                <div class="list-group-item nested-2"> <i
                                        class="mdi mdi-language-html5 fs-16 align-middle text-danger me-2"></i> index
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    <!-- sortablejs -->
    <script src="{{ URL::asset('build/libs/sortable/sortable.min.js') }}"></script>
