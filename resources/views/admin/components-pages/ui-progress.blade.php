...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Progress" pagetitle="Base UI" />
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use <code>bg-</code> class to progress bar class with the below-mentioned color
                        variation to set the background color progress bar.</p>
...
&lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>bg-</code> class to progress bar class with the below-mentioned color
                        to change the appearance of individual progress bars.</p>
                    <div class="progress">
    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>animated-progress custom-progess </code> class to show custom progress
                        with animation.</p>
                    <div>
