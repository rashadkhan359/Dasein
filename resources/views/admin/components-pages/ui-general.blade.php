...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="General" pagetitle="Base UI" />
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="hstack flex-wrap gap-2">
                        <button type="button" class="btn btn-light tooltip-primary" data-bs-container="body"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-4 mt-lg-0">
                                    ...
                                    <p class="text-muted">Use <code>disabled</code> class to links that appear un-clickable
                                        and <code>active</code> class to indicate the current page.</p>
                                ...
                                <div class="mt-4">
                                    ...
                                    <nav aria-label="...">
                                        <ul class="pagination pagination-sm">
                                            <li class="page-item disabled flex-wrap">
                                                <a class="page-link" href="#" tabindex="-1">← &nbsp; Prev</a>
                                            </li>
                                            <li class="page-item"><a class="page-link" href="#">1</a></li>
                                            <li class="page-item"><a class="page-link" href="#">2</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-4">
                                    ...
                                    <ul class="pagination pagination-lg pagination-separated flex-wrap">
                                        <li class="page-item disabled">
                                    ...
                                    <!-- Pagination rounded -->
                                    <ul class="pagination pagination-separated flex-wrap">
                                        <li class="page-item disabled">
                                            <a href="#" class="page-link">←</a>
                                        </li>
                                        <li class="page-item">
                                    ...
                                    <!-- Custom Separated Pagination Large -->
                                    <ul class="pagination pagination-sm pagination-separated flex-wrap">
                                        <li class="page-item disabled">
                                            <a href="#" class="page-link">←</a>
                                        </li>
                                        <li class="page-item">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-4">
                                    ...
                                    <!-- Pagination rounded -->
                                    <ul class="pagination pagination-lg pagination-rounded flex-wrap">
                                        <li class="page-item disabled">
                                            <a href="#" class="page-link">←</a>
                                        </li>
                                        <li class="page-item">
