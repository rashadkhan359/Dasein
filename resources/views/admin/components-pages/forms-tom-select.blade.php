...
@section('css')
    <!-- add extra css -->
    <link href="{{ URL::asset('build/libs/tom-select/tom-select.bootstrap5.min.css') }}" rel="stylesheet">
@endsection
@section('content')
    <!-- page title -->
                ...
                <div class="card-body">
                    ...
                    <div>
                        <select class="data-flag">
                            <option value="Ascension Island" data-src="{{ URL::asset('build/images/flags/ac.svg') }}">Ascension Island
                            </option>
                            <option value="Andorra" data-src="{{ URL::asset('build/images/flags/ad.svg') }}">Andorra</option>
                            <option value="United Arab Emirates" data-src="{{ URL::asset('build/images/flags/ae.svg') }}">United Arab
                                Emirates</option>
                            <option value="Afghanistan" data-src="{{ URL::asset('build/images/flags/af.svg') }}">Afghanistan</option>
                            <option value="Antigua and Barbuda" data-src="{{ URL::asset('build/images/flags/ag.svg') }}">Antigua and Barbuda
                            </option>
                            <option value="Anguilla" data-src="{{ URL::asset('build/images/flags/ai.svg') }}">Anguilla</option>
                            <option value="Armenia" data-src="{{ URL::asset('build/images/flags/am.svg') }}">Armenia</option>
                            <option value="Angola" data-src="{{ URL::asset('build/images/flags/ao.svg') }}">Angola</option>
                            <option value="Antarctica" data-src="{{ URL::asset('build/images/flags/aq.svg') }}">Antarctica</option>
                            <option value="Argentina" data-src="{{ URL::asset('build/images/flags/ar.svg') }}">Argentina</option>
                            <option value="American Samoa" data-src="{{ URL::asset('build/images/flags/as.svg') }}">American Samoa</option>
                            <option value="Austria" data-src="{{ URL::asset('build/images/flags/at.svg') }}">Austria</option>
                            <option value="Australia" data-src="{{ URL::asset('build/images/flags/au.svg') }}">Australia</option>
                        </select>
                    </div>
                </div>
                <div class="row g-0">
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/libs/tom-select/tom-select.complete.min.js') }}"></script>
    <script src="{{ URL::asset('build/libs/tom-select/remove_button.js') }}"></script>

    <script src="{{ URL::asset('build/js/pages/tom-select.init.js') }}"></script>
