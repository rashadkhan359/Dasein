...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/libs/jsvectormap/us-merc-en.js') }}"></script>
    <script src="{{ URL::asset('build/libs/jsvectormap/canada.js') }}"></script>
    <script src="{{ URL::asset('build/libs/jsvectormap/russia.js') }}"></script>
    <script src="{{ URL::asset('build/libs/jsvectormap/spain.js') }}"></script>
