...
@section('css')
    <!-- extra css -->
    <!-- jsvectormap css -->
    <link href="{{ URL::asset('backend/build/libs/jsvectormap/jsvectormap.min.css') }}" rel="stylesheet" type="text/css">
        ...
        <div class="col-xxl-9 order-last">
            ...
            <div class="card overflow-hidden">
                <div class="position-absolute opacity-50 start-0 end-0 top-0 bottom-0"
                    style="background-image: url('backend/build/images/sidebar/body-light-1.png');"></div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div>
                                                <img src="{{ URL::asset('backend/build/images/flags/us.svg') }}" alt="" height="18"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div>
                                                <img src="{{ URL::asset('backend/build/images/flags/gl.svg') }}" alt="" height="18"
                                                    class="rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div>
                                                <img src="{{ URL::asset('backend/build/images/flags/br.svg') }}" alt="" height="18"
                                                    class="rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div>
                                                <img src="{{ URL::asset('backend/build/images/flags/au.svg') }}" alt="" height="18"
                                                    class="rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div>
                                                <img src="{{ URL::asset('backend/build/images/flags/ru.svg') }}" alt="" height="18"
                                                    class="rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div>
                                                <img src="{{ URL::asset('backend/build/images/flags/ca.svg') }}" alt="" height="18"
                                                    class="rounded-circle">
                                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/users/avatar-4.jpg') }}" alt=""
                                                    class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/users/avatar-3.jpg') }}" alt=""
                                                    class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/users/avatar-10.jpg') }}" alt=""
                                                    class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/users/avatar-9.jpg') }}" alt=""
                                                    class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/users/avatar-8.jpg') }}" alt=""
                                                    class="avatar-xxs rounded-circle">
                                            </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/products/img-1.png') }}" alt=""
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/products/img-5.png') }}" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="product-overview"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/products/img-4.png') }}" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="product-overview"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/products/img-3.png') }}" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="product-overview"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/products/img-2.png') }}" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="product-overview"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('backend/build/images/products/img-8.png') }}" alt=""
                                                    class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1"><a href="product-overview"
                    ...
                    <div data-simplebar style="max-height: 415px;">
                        <div class="vstack gap-3 px-3">
                            ...
                            <div class="p-3 border border-dashed rounded-3">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                        <img src="{{ URL::asset('backend/build/images/products/img-6.png') }}" alt=""
                                            class="img-fluid d-block">
                                    </div>
                                    <div class="flex-grow-1">
                                        <a href="product-overview">
                            ...
                            <div class="p-3 border border-dashed rounded-3">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                        <img src="{{ URL::asset('backend/build/images/products/img-9.png') }}" alt=""
                                            class="img-fluid d-block">
                                    </div>
                                    <div class="flex-grow-1">
                                        <a href="product-overview">
            ...
            <div class="card card-height-100">
                ...
                <div data-simplebar style="max-height: 445px;">
                    <div class="p-3 border-bottom border-bottom-dashed">
                        <div class="d-flex align-items-center gap-2">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('backend/build/images/users/avatar-2.jpg') }}" alt=""
                    ...
                    <div class="p-3 border-bottom border-bottom-dashed">
                        <div class="d-flex align-items-center gap-2">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('backend/build/images/users/avatar-1.jpg') }}" alt=""
                                    class="rounded dash-avatar">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="p-3 border-bottom border-bottom-dashed">
                        <div class="d-flex align-items-center gap-2">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('backend/build/images/users/avatar-5.jpg') }}" alt=""
                                    class="rounded dash-avatar">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="p-3 border-bottom border-bottom-dashed">
                        <div class="d-flex align-items-center gap-2">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('backend/build/images/users/avatar-6.jpg') }}" alt=""
                                    class="rounded dash-avatar">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="p-3 border-bottom border-bottom-dashed">
                        <div class="d-flex align-items-center gap-2">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('backend/build/images/users/avatar-7.jpg') }}" alt=""
                                    class="rounded dash-avatar">
                            </div>
                            <div class="flex-grow-1">
...
@section('scripts')
    ...
    <!-- Vector map-->
    <script src="{{ URL::asset('backend/build/libs/jsvectormap/jsvectormap.min.js') }}"></script>
    <script src="{{ URL::asset('backend/build/libs/jsvectormap/world-merc.js') }}"></script>

    <script src="{{ URL::asset('backend/build/libs/list.js/list.min.js') }}"></script>
        ...
        if (vectorMapWorldLineColors)
            var worldlinemap = new jsVectorMap({
                ...
                markers: [{
                        ...
                        style: {
                            image: "{{ asset('backend/build/images/flags/gl.svg') }}",
                        }
                    },
                    {
                        name: "Canada",
                        ...
                        style: {
                            image: "{{ asset('backend/build/images/flags/ca.svg') }}",
                        }
                    },
                    {
                        name: "Brazil",
                        ...
                        style: {
                            image: "{{ asset('backend/build/images/flags/br.svg') }}",
                        }
                    },
                    {
                        name: "Serbia",
                        ...
                        style: {
                            image: "{{ asset('backend/build/images/flags/rs.svg') }}",
                        }
                    },
                    {
                        name: "Russia",
                        coords: [61, 105],
                        style: {
                            image: "{{ asset('backend/build/images/flags/ru.svg') }}",
                        }
                    },
                    {
                        name: "US",
                        ...
                        style: {
                            image: "{{ asset('backend/build/images/flags/us.svg') }}",
                        }
                    },
                    {
                        name: "Australia",
                        ...
                        style: {
                            image: "{{ asset('backend/build/images/flags/au.svg') }}",
                        }
                    },
                ],
                lines: [{
