...
@section('content')
    ...
    <section class="position-relative">
        ...
        style="background-image: url('{{ asset('build/images/profile-bg.jpg') }}'); background-size: cover; background-position: center; height: 300px;">
                ...
                <div class="col-lg-12">
                    <div class="pt-3">
                        <div class="mt-n5 d-flex gap-3 flex-wrap align-items-end">
                            <img @if (auth()->user()->avatar) src="{{ URL::asset(auth()->user()->avatar) }}"
                                    @else
                                    src="https://ui-avatars.com/api/?background=random&name={{ auth()->user()->firstname }}+{{ auth()->user()->lastname }}" @endif
                                        alt="" class="avatar-xl rounded p-1 bg-light mt-n3">
                            <div>
                                <h5 class="fs-18">{{ @Auth::user()->fullname }}</h5>
                            ...
                            <div class="ms-md-auto">
                                ...
                                <a href="product-list" class="btn btn-success btn-hover">
                                    <i class="bi bi-cart4 me-1 align-middle"></i>
                                    Shopping Now
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-4">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <a href="#edit_info" class="badge badge-soft-info text-info" data-bs-toggle="modal"><i
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div>
                                                                <label for="oldpasswordInput" class="form-label">Old
                                                                    Password*</label>
                                                                    <div
                                                                    class="position-relative auth-pass-inputgroup  @error('current_password') is-invalid @enderror">
                                                                    <input type="password" class="form-control pe-5 password-input"
                                                                        onpaste="return false" placeholder="Old password" name="current_password"
                                                                        id="current-password" required>
                                                                    <button onclick="showPassword('current-password')"
                                                                        class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon ri-eye-fill"
                                                                        type="button" id="current-password-icon">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div>
                                                                <label for="newpasswordInput" class="form-label">New
                                                                    Password*</label>
                                                                    <div
                                                                    class="position-relative auth-pass-inputgroup @error('password') is-invalid @enderror">
                                                                    <input type="password" class="form-control pe-5 password-input "
                                                                        onpaste="return false" placeholder="Enter password" id="password-input"
                                                                        name="password" aria-describedby="passwordInput"
                                                                        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                                                    <button onclick="showPassword('password-input')"
                                                                        class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon ri-eye-fill"
                                                                        type="button" id="password-input-icon">
                                                                        {{-- <i class="ri-eye-fill align-middle"></i> --}}
                                                                    </button>
                                                                </div>
                                                                @error('password')
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div>
                                                                <label for="confirmpasswordInput"
                                                                    ...
                                                                    <div
                                                                    class="position-relative auth-pass-inputgroup @error('password_confirmation') is-invalid @enderror">
                                                                    <input type="password" class="form-control pe-5 password-input"
                                                                        onpaste="return false" placeholder="Confirm password"
                                                                        name="password_confirmation" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                                                        id="confirm-password-input" required>
                                                                    <button onclick="showPassword('confirm-password-input')"
                                                                        class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon ri-eye-fill"
                                                                        type="button" id="confirm-password-input-icon">
                                                                        {{-- <i class="ri-eye-fill align-middle"></i> --}}
                                                                    </button>
                                                                </div>
    ...
    <section class="section bg-light bg-opacity-25"
        style="background-image: url('{{ asset('build/images//ecommerce/bg-effect.png') }}');background-position: center; background-size: cover;">
        <div class="container">
    ...
    <x-main-modal :id="'edit_info'" :maxWidth="'lg'" :label="'editInfo'" :position="'center'" :scroll="'noscroll'">
        <x-slot name="header">
            <h4>{{ __('Edit Personal Info') }}</h4>
        </x-slot>
        <x-slot name="content">
                        ...
                        <div class="card mt-2">
                            <div class="card-body">
                                <div class="position-relative">
                                    ...
                                    @else
                                    src="https://ui-avatars.com/api/?background=random&name={{ auth()->user()->firstname }}+{{ auth()->user()->lastname }}" @endif
                                        alt="" class="avatar-xl rounded p-1 bg-light mt-n3" id="profile_img">
                                    <input type="file" hidden style="display: hidden;" name="avatar" id="avatar">
                                </div>
                                <div class="text-start mt-2">
                                    <label for="avatar" class="btn btn-dark">Choose</label>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                                id="emailInput" name="email" placeholder="name@toner.com"
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                                id="phoneInput" name="phone" placeholder="Enter phone number"
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" data-provider="flatpickr" id="birdthdatInput"
                                                data-date-format="d M, Y" data-deafult-date="24 Nov, 2021"
                                                placeholder="{{ auth()->user()->created_at }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control @error('country') is-invalid @enderror"
                                                id="countryInput" name="country" placeholder="Country"
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control @error('zip') is-invalid @enderror"
                                                minlength="5" maxlength="6" name="zip" id="zipcodeInput"
                                                placeholder="Enter zipcode" value="{{ old('zip', auth()->user()->zip) }}">
                                            @error('zip')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function showPassword(id) {
            ...
            icon.classList.toggle("ri-eye-fill", !isPasswordVisible);
