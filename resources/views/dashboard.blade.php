            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item @if($loop->iteration == 1) active @endif">
                    <div class="ecommerce-home bg-danger-subtle"
                        style="background-image: url('{{ URL::asset('storage/' . $slider->image)}}');">
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7">
                                    <div class="text-sm-end">
                                        <p class="fs-15 fw-semibold text-uppercase"><i
                                                class="ri-flashlight-fill text-primary align-bottom me-1"></i>{{ $slider->mini_title }}</p>
                                        <h1 class="display-4 fw-bold lh-base text-capitalize mb-3">{{ $slider->main_title }}</h1>
                                        <p class="fs-20 mb-4">{{ $slider->sub_title }}</p>
                                        <a href="{{ $slider->button_url }}" class="btn btn-{{ $slider->button_color }} btn-hover"><i
                                                class="ph-shopping-cart align-middle me-1"></i>Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
