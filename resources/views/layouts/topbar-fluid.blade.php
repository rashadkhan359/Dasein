            ...
            <ul class="navbar-nav mx-lg-auto mb-2 mb-lg-0" id="navigation-menu">
                <li class="nav-item d-block d-lg-none">
                    <a class="d-block p-3 h-auto text-center" href="index.html">
                        <img src="{{ URL::asset('build/images/logo-dark.png') }}" alt="" height="60" class="card-logo-dark mx-auto">
                        <img src="{{ URL::asset('build/images/logo-light.png') }}" alt="" height="60" class="card-logo-light mx-auto">
                    </a>
                </li>
