            ...
            <ul class="navbar-nav mx-lg-auto mb-2 mb-lg-0" id="navigation-menu">
                ...
                {{-- <li class="nav-item dropdown dropdown-hover">
                    ...
                    <ul class="dropdown-menu dropdown-menu-md dropdown-menu-center dropdown-menu-list submenu">
                        ...
                        <li class="nav-item">
                            <a href="watch-main-layout" class="nav-link"
                                data-key="t-unique-watches">{{ __('t-unique-watches') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="modern-fashion" class="nav-link"
                                data-key="t-modern-fashion">{{ __('t-modern-fashion') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="trend-fashion" class="nav-link"
                                data-key="t-trend-fashion">{{ __('t-trend-fashion') }}</a>
                        </li>
                    </ul>
                </li>
                        ...
                        <div class="row g-0 g-lg-4">
                            <div class="col-lg-2 d-none d-lg-block">
                                <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden"
                                    style="background-image: url('build/images/ecommerce/img-1.jpg');background-size: cover;">
                                    <div class="bg-overlay bg-light bg-opacity-25"></div>
                                    <div class="card-body d-flex align-items-center justify-content-center">
                                        <div class="text-center">
                                            <a href="product-grid-sidebar-banner" class="btn btn-secondary btn-hover"><i
                                                    class="ph-storefront align-middle me-1"></i> <span
                                                    data-key="t-shop-now">{{ __('t-shop-now') }}</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                    <li>
                                        <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                            data-key="t-men">{{ __('t-men') }}</p>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-grid-sidebar-banner" class="nav-link"
                                            data-key="t-clothing">{{ __('t-clothing') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-grid-right" class="nav-link"
                                            data-key="t-watches">{{ __('t-watches') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list-left" class="nav-link"
                                            data-key="t-bags-Luggage">{{ __('t-bags-Luggage') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-grid-right" class="nav-link"
                                            data-key="t-footwear">{{ __('t-footwear') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list" class="nav-link"
                                            data-key="t-innerwear">{{ __('t-innerwear') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list-right" class="nav-link"
                                            data-key="t-other-accessories">{{ __('t-other-accessories') }}</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-2">
                                <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                    <li>
                                        <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                            data-key="t-women">{{ __('t-women') }}</p>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list-defualt" class="nav-link"
                                            data-key="t-western-wear">{{ __('t-western-wear') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list-left" class="nav-link"
                                            data-key="t-handbags-clutches">{{ __('t-handbags-clutches') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-grid-right" class="nav-link"
                                            data-key="t-lingerie-nightwear">{{ __('t-lingerie-nightwear') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-grid-sidebar-banner" class="nav-link"
                                            data-key="t-footwear">{{ __('t-footwear') }}</a>
                                    ...
                                    <li class="nav-item">
                                        <a href="product-grid-defualt" class="nav-link"
                                            data-key="t-fashion-silver-jewellery">{{ __('t-fashion-silver-jewellery') }}</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-2">
                                <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                    <li>
                                        <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                            data-key="t-accessories-others">{{ __('t-accessories-others') }}</p>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-grid-right" class="nav-link"
                                            data-key="t-home-kitchen-pets">{{ __('t-home-kitchen-pets') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list-left" class="nav-link"
                                            data-key="t-beauty-health-grocery">{{ __('t-beauty-health-grocery') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-grid-sidebar-banner" class="nav-link"
                                            data-key="t-sports-fitness-bags-luggage">{{ __('t-sports-fitness-bags-luggage') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list" class="nav-link"
                                            data-key="t-car-motorbike-industrial">{{ __('t-car-motorbike-industrial') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="product-list-right" class="nav-link"
                                            data-key="t-books">{{ __('t-books') }}</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-2">
                                <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                    <li>
                                        <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                            data-key="t-others">{{ __('t-others') }}</p>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-lg-4">
                                            <a href="#!"
                                                ...
                                                <img src="{{ URL::asset('build/images/brands/img-8.png') }}"
                                                    alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!"
                                                class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ URL::asset('build/images/brands/img-2.png') }}"
                                                    alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!"
                                                class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ URL::asset('build/images/brands/img-3.png') }}"
                                                    alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!"
                                                class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ URL::asset('build/images/brands/img-4.png') }}"
                                                    alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!"
                                                class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ URL::asset('build/images/brands/img-5.png') }}"
                                                    alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!"
                                                class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ URL::asset('build/images/brands/img-6.png') }}"
                                                    alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="dropdown-menu dropdown-mega-menu-xl dropdown-menu-center p-0">
                            <div class="row g-0 g-lg-4">
                                <div class="col-lg-5 d-none d-lg-block">
                                    <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden"
                                        style="background-image: url('build/images/ecommerce/img-2.jpg'); background-size: cover;">
                                        ...
                                        <div
                                            ...
                                            <div class="text-center">
                                                <h6 class="card-title text-white">Shop For {{ $category->name }}</h6>
                                    ...
                                    <div class="row g-0 g-lg-4">
                                        <div class="col-lg-6">
                                            <div class="py-3">
                                                <ul class="dropdown-menu-list list-unstyled mb-0">
                                                    ...
                                                    @empty
                                                    <li>
                                                        <p class="nav-item text-muted"
                                                            data-key="t-checkout-pages">No categories</p>
                                                    </li>
                                                    @endforelse
                                                </ul>
                                            </div>
                                        ...
                                        {{-- <div class="col-lg-6">
                                            <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                                <li>
                                                    <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                                        data-key="t-support">{{ __('t-support') }}</p>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="shop-cart" class="nav-link"
                                                        data-key="t-shopping-cart">{{ __('t-shopping-cart') }}</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="checkout" class="nav-link"
                                                        data-key="t-checkout">{{ __('t-checkout') }}</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="wishlist" class="nav-link"
                                                        data-key="t-wishlist">{{ __('t-wishlist') }}</a>
                                                </li>
                                            </ul>
                                        </div> --}}
                                    </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-md dropdown-menu-center dropdown-menu-list submenu">
                        <li class="nav-item dropdown dropdown-hover">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false" data-key="t-products">{{ __('t-products') }}</a>
                            <ul class="dropdown-menu submenu">
                                <li class="dropdown dropdown-hover">
                                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                        aria-expanded="false" data-key="t-grid-view">{{ __('t-grid-view') }}</a>
                                    <ul class="dropdown-menu submenu">
                                        <li><a class="nav-link" href="product-grid-defualt"
                                                data-key="t-defualt">{{ __('t-defualt') }}</a></li>
                                        <li><a class="nav-link" href="product-grid-sidebar-banner"
                                                data-key="t-sidebar-with-banner">{{ __('t-sidebar-with-banner') }}</a>
                                        </li>
                                        <li><a class="nav-link" href="product-grid-right"
                                                data-key="t-right-sidebar">{{ __('t-right-sidebar') }}</a></li>
                                        <li><a class="nav-link" href="product-grid"
                                                data-key="t-no-sidebar">{{ __('t-no-sidebar') }}</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown dropdown-hover">
                                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                        aria-expanded="false" data-key="t-list-view">{{ __('t-list-view') }}</a>
                                    <ul class="dropdown-menu submenu">
                                        <li><a class="nav-link" href="product-list-defualt"
                                                data-key="t-defualt">{{ __('t-defualt') }}</a></li>
                                        <li><a class="nav-link" href="product-list-left"
                                                data-key="t-left-sidebar">{{ __('t-left-sidebar') }}</a></li>
                                        <li><a class="nav-link" href="product-list-right"
                                                data-key="t-right-sidebar">{{ __('t-right-sidebar') }}</a></li>
                                        <li><a class="nav-link" href="product-list"
                                                data-key="t-no-sidebar">{{ __('t-no-sidebar') }}</a></li>
                                    </ul>
                                </li>
                                <li><a class="nav-link" href="product-details"
                                        data-key="t-product-details">{{ __('t-product-details') }}</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown dropdown-hover">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false" data-key="t-users">{{ __('t-users') }}</a>
                            <ul class="dropdown-menu submenu">
                                <li><a class="nav-link" href="account"
                                        data-key="t-my-account">{{ __('t-my-account') }}</a></li>
                                <li><a class="nav-link" href="auth-signin-basic"
                                        data-key="t-sign-in">{{ __('t-sign-in') }}</a></li>
                                <li><a class="nav-link" href="auth-signup-basic"
                                        data-key="t-sign-up">{{ __('t-sign-up') }}</a></li>
                                <li><a class="nav-link" href="auth-pass-reset-basic"
                                        data-key="t-passowrd-reset">{{ __('t-passowrd-reset') }}</a></li>
                                <li><a class="nav-link" href="auth-pass-change-basic"
                                        data-key="t-create-password">{{ __('t-create-password') }}</a></li>
                                <li><a class="nav-link" href="auth-success-msg-basic"
                                        data-key="t-success-message">{{ __('t-success-message') }}</a></li>
                                <li><a class="nav-link" href="auth-twostep-basic"
                                        data-key="t-two-step-verify">{{ __('t-two-step-verify') }}</a></li>
                                <li><a class="nav-link" href="auth-logout-basic"
                                        data-key="t-logout">{{ __('t-logout') }}</a></li>
                                <li><a class="nav-link" href="auth-404"
                                        data-key="t-error-404">{{ __('t-error-404') }}</a></li>
                                <li><a class="nav-link" href="auth-500"
                                        data-key="t-error-500">{{ __('t-error-500') }}</a></li>
                                <li><a class="nav-link" href="coming-soon"
                                        data-key="t-coming-soon">{{ __('t-coming-soon') }}</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="products-category" class="nav-link"
                        ...
                        <li class="nav-item">
                            <a href="purchase-guide" class="nav-link"
                                data-key="t-purchase-guide">{{ __('t-purchase-guide') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="terms-conditions" class="nav-link"
                                data-key="t-terms-of-service">{{ __('t-terms-of-service') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="privacy-policy" class="nav-link"
                                data-key="t-privacy-policy">{{ __('t-privacy-policy') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="store-locator" class="nav-link"
                                data-key="t-store-locator">{{ __('t-store-locator') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown dropdown-hover">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false" data-key="t-email-template">{{ __('t-email-template') }}</a>
                            <ul class="dropdown-menu submenu">
                                <li><a class="nav-link" href="email-black-friday"
                                        data-key="t-black-friday">{{ __('t-black-friday') }}</a></li>
                                <li><a class="nav-link" href="email-flash-sale"
                                        data-key="t-flash-sale">{{ __('t-flash-sale') }}</a></li>
                                <li><a class="nav-link" href="email-order-success"
                                        data-key="t-order-success">{{ __('t-order-success') }}</a></li>
                                <li><a class="nav-link" href="email-order-success-2"
                                        data-key="t-order-success-2">{{ __('t-order-success-2') }}</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown dropdown-hover">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false" data-key="t-multi-level">{{ __('t-multi-level') }}</a>
                            <ul class="dropdown-menu submenu">
                                <li><a class="nav-link" href="#"
                                        data-key="t-level-1.1">{{ __('t-level-1.1') }}</a></li>
                                <li><a class="nav-link" href="#"
                                        data-key="t-level-1.2">{{ __('t-level-1.2') }}</a></li>
                                <li class="dropdown dropdown-hover">
                                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                        aria-expanded="false" data-key="t-level-1.3">{{ __('t-level-1.3') }}</a>
                                    <ul class="dropdown-menu submenu">
                                        <li><a class="nav-link" href="#"
                                                data-key="t-level-2.1">{{ __('t-level-2.1') }}</a></li>
                                        <li><a class="nav-link" href="#"
                                                data-key="t-level-2.2">{{ __('t-level-2.2') }}</a></li>
                                        <li class="dropdown dropdown-hover">
                                            <a href="#" class="nav-link dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-expanded="false"
                                                data-key="t-level-2.3">{{ __('t-level-2.3') }}</a>
                                            <ul class="dropdown-menu submenu">
                                                <li><a class="nav-link" href="#"
                                                        data-key="t-level-3.1">{{ __('t-level-3.1') }}</a></li>
                                                <li><a class="nav-link" href="#"
                                                        data-key="t-level-3.2">{{ __('t-level-3.2') }}</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
            ...
            <div class="dropdown header-item dropdown-hover-end">
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="@if (@Auth::user()->avatar) {{ asset(auth()->user()->avatar) }} @else {{ URL::asset('build/images/users/user-dummy-img.jpg') }} @endif"
                        alt="Header Avatar">
                </button>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    @auth
                        ...
                        <a class="dropdown-item" href="track-order"><i
                                class="bi bi-truck text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Track Orders</span></a>
                        <a class="dropdown-item" href="ecommerce-faq">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a class="dropdown-item" href="{{ route('logout') }}"
                                ...
                                <span class="align-middle" data-key="t-logout">{{ __('t-logout') }}</span>
                            </a>
                        </form>
                    @else
                        <!-- item-->
                        <h6 class="dropdown-header text-center">Welcome!</h6>
                        <a class="dropdown-item text-center sign-up" href="{{ route('register') }}">
                            <i class="bi bi-person-plus-fill text-muted fs-15 align-middle me-1"></i>
                            <span class="align-middle">Sign Up</span>
                        </a>
                        <p class="text-center text-info">Not a member yet?</p>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-center login" href="{{ route('login') }}">
                            <i class="bi bi-box-arrow-in-right text-muted fs-15 align-middle me-1"></i>
...
<div class="offcanvas offcanvas-end product-list" tabindex="-1" id="ecommerceCart"
    ...
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id="ecommerceCartLabel">My Cart <span
                class="badge bg-danger align-middle ms-1 cartitem-badge">4</span></h5>
                ...
                <li class="list-group-item product">
                    <div class="d-flex gap-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex mb-3 gap-2">
                                <div class="text-muted fw-medium mb-0">$<span class="product-price">160.00</span>
                                </div>
                                <div class="vr"></div>
                                <span class="text-success fw-medium">In Stock</span>
                            </div>
                ...
                <li class="list-group-item product">
                    <div class="d-flex gap-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex mb-3 gap-2">
                                <div class="text-muted fw-medium mb-0">$ <span class="product-price">244.99</span>
                                </div>
                                <div class="vr"></div>
                                <span class="text-success fw-medium">In Stock</span>
                            </div>
                ...
                <li class="list-group-item product">
                    <div class="d-flex gap-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex mb-3 gap-2">
                                <div class="text-muted fw-medium mb-0">$<span class="product-price">120.30</span>
                                </div>
                                <div class="vr"></div>
                                <span class="text-success fw-medium">In Stock</span>
                            </div>
